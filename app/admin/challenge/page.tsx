...
export default function AdminChallenge() {
    const [answers, setAnswers] = useState(["", ""]) // two questions
        ...
        <div className="min-h-screen bg-[#fdfdfd] flex items-center justify-center px-6">
            <div className="w-full max-w-md space-y-8 animate-fadeIn">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-zinc-500">Prove you belong here by answering these two questions.</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-xs font-mono uppercase tracking-widest text-zinc-400">1. Launch Year?</label>
                            <input
                                type="text"
                                required
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-mono uppercase tracking-widest text-zinc-400">2. Admin Name?</label>
                            <input
                                type="password"
                                required
                                className="w-full px-4 py-3 rounded-xl border border-zinc-200 bg-white text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900/5 transition-all"
